					...
					{#each paginatedGroups as group, index}
						...
						>
							...
							<div class="absolute -right-2 -top-2 z-10">
								<div
									class="rounded-full border border-orange-400 bg-orange-500 px-2 py-0.5 text-sm font-semibold text-black shadow-lg"
								>
							...
							<div class="relative p-6">
								...
								<div class="mb-6">
									<div class="mb-2 flex items-center gap-3">
										<div
											class="h-3 w-3 rounded-full bg-orange-500 shadow-lg shadow-orange-500/50"
										></div>
